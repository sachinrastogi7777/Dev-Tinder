...
const validateSignupData = (data) => {
    ...
    if (!Array.isArray(data.skills) || data.skills.length > 10) {
        throw new Error("Only up to 10 skills are allowed");
    }
}
...
module.exports = { ageValidation, phoneNumberValidation, emailValidation, passwordValidation, genderValidation, validateSignupData };
